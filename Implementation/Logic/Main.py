...
if __name__ == "__main__":
    ...
    loss_args = {'reg_param': 0.2, 'rho': 0.2}
    loss_fn = LossHandler(LossType.SPARSE_KL, loss_args)
    aeModel = MWE_AE(d.input_dim_train(), L)
    optim = torch.optim.Adam(aeModel.parameters(), lr = 0.01)
    instanceModel = TrainingModel("MWP_KL", d.X_train_batch, d.Y_train_batch, d.X_test_batch, d.Y_test_batch,
